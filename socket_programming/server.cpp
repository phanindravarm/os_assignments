...
int main()
{
    ...
    // serverSocket listens and max connections in queue is 5
    while (true)
    {
        sleep(5);
        int clientSocket1 = accept(serverSocket, nullptr, nullptr); // creating a descriptor so that os knows where is clietSocket and it communicates with this
